...
1. **Task 1:** As the Student Digital Ambassador, you need to create a one-page visual resource that helps your batchmates understand what Digital Literacy means and why it matters.
...
2. **Task 2:** A professional digital presence is no longer optional — it is expected. In this task, you will set up your foundational portfolio across the key platforms that employers, internship coordinators, and the academic community check.
...
3. **Task 3:** As a Digital Ambassador, you need to be able to guide your peers toward the right online tools for studying, practising, and collaborating. This task builds familiarity with two categories: coding practice platforms and cloud collaboration tools.
   
   **Part A:** Coding Practice
   
   I attempted CodeChef *Python Introductory Challenge*.
   
   **Part B:** Google Workshop Collaboration
   
   **Link to Google Form:** [Click Here](https://forms.gle/XUndZHwvD1VJMwmR7)

4. **Task 4:** As a Digital Ambassador, one of your responsibilities is teaching your peers how to communicate professionally online. This task tests whether you can apply email etiquette yourself, and whether you can communicate those rules clearly to others.
